// SMALLBIZ_TENANT_SUPERADMIN_PERMISSIONS_V1
...
async function loadContext(){
  ...
  const {data:permissions,error}=await sb.from("permissions").select("id,code,name,module").order("module").order("code");
